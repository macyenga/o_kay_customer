import 'package:o_kay_customer/data/model/response/language_model.dart';

class AppConstants {
  static const String APP_NAME = 'Kay';
  ...
  static const String GET_JOBS_LIST =
      "/api/v1/jobs/get_user_jobs"; //body=?lang=ar

  static const String SEARCH_JOBS =
      "/api/v1/jobs/search_jobs"; //POST    {user_job_id : 1 , city_id : 2}

  static const String GET_REGIONS =
      "/api/v1/places/get_regions"; //body=?lang=ar

  static const String GET_REGION_CITIES =
      "/api/v1/places/get_region_cities"; //PATH regionId   ?lang=ar
...
// catogry_id    POST REQUEST
  ...
  static const String GOOGLE_MAP_KEY =
      "AIzaSyCsE5KDJqjPpbTHsQFqSjnJHclQuCBw8c4";
